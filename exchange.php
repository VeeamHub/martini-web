...
$(document).on("click", ".download-msg", function(e) {
	...
	$.get("core/veeam.php", {"action" : "exportmailitem", "itemid" : itemid, "mailboxid" : mailboxid, "rid" : rid, "json" : json}).done(function(data) {
		e.preventDefault();
		if (data) {
...
$(document).on("click", ".download-pst", function(e) {
	...
	$.get("core/veeam.php", {"action" : act, "itemid" : itemid, "mailboxid" : mailboxid, "rid" : rid, "json" : json}).done(function(data) {
		e.preventDefault();
...
function loadMessages(folderid, mailboxid, rid, offset, cleartable) {
    $.get("core/veeam.php", {"action" : "getmailitems",  "folderid" : folderid, "offset" : offset, "mailboxid" : mailboxid, "rid" : rid}).done(function(data) {
