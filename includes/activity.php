...
if (isset($_SESSION['connected'])) {
	...
	$sessions = $veeam->getRestoreSessions();
	$time = array();
...
$(document).on("click", ".item", function(e) {
    ...
    $.get("core/veeam.php", {"action" : "getrestoresessionevents", "id" : id}).done(function(data) {
...
function loadSessions(offset) {
    ...
    $.get("core/veeam.php", {"action" : "getrestoresessions", "offset" : offset}).done(function(data) {
