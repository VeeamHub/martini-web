...
$(document).on("click", ".item", function(e) {
    ...
    $.get("core/veeam.php", {"action" : "getbackupsessionlog", "id" : id}).done(function(data) {
...
$(document).on("click", "#btn-change-job-state", function(e) {
    ...
    $.get("core/veeam.php", {"action" : "changejobstate", "id" : jid, "json" : json}).done(function(data) {              
        if (call == "enable") {
...
$(document).on("click", "#btn-job-start", function(e) {
    ...
    $.get("core/veeam.php", {"action" : action, "id" : id}).done(function(data) {
		Swal.fire({
			type: 'info',
			title: 'Job status',
			text: data
