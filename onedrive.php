...
$(document).on("click", ".download-file", function(e) {
	...
	$.get("core/veeam.php", {"action" : "exportonedriveitem", "itemid" : itemid, "userid" : userid, "rid" : rid, "json" : json, "type" : filetype}).done(function(data) {
		e.preventDefault();
...
$(document).on("click", ".download-zip", function(e) {
	...
	$.get("core/veeam.php", {"action" : act, "itemid" : itemid, "userid" : userid, "rid" : rid, "json" : json, "type" : filetype}).done(function(data) {
		e.preventDefault();
...
function loadFolderItems(folderid, parentid, rid, userid) { /* Used for navigation to next folder */
    ...
    $.get("core/veeam.php", {"action" : "getonedriveitemsbyfolder", "folderid" : folderid, "rid" : rid, "userid" : userid, "type" : "folders"}).done(function(data) {
        responsefolders = JSON.parse(data);
    });

    /* Second we load the documents */
    $.get("core/veeam.php", {"action" : "getonedriveitemsbyfolder", "folderid" : folderid, "rid" : rid, "userid" : userid, "type" : "documents"}).done(function(data) {
...
function loadParentFolderItems(parentid, rid, userid) { /* Used for navigation to parent folder */
    ...
    /* First we load the folders */
    $.get("core/veeam.php", {"action" : "getonedriveitemsbyfolder", "folderid" : parentid, "rid" : rid, "userid" : userid, "type" : "folders"}).done(function(data) {
        responsefolders = JSON.parse(data);
    });

    /* Second we load the documents */
    $.get("core/veeam.php", {"action" : "getonedriveitemsbyfolder", "folderid" : parentid, "rid" : rid, "userid" : userid, "type" : "documents"}).done(function(data) {
        responsedocuments = JSON.parse(data);
    });
    ...
    setTimeout(function(e) {
        if (typeof responsefolders !== undefined && responsefolders.results.length != '0') {
            ...
            $.get("core/veeam.php", {"action" : "getonedriveparentfolder", "folderid" : newparentid, "rid" : rid, "userid" : userid, "type" : "folders"}).done(function(data) {
            ...
            $.get("core/veeam.php", {"action" : "getonedriveparentfolder", "folderid" : newparentid, "rid" : rid, "userid" : userid, "type" : "documents"}).done(function(data) {
                parentdata = JSON.parse(data);
...
function loadItems(folderid, userid, rid, offset) { /* Used for loading additional items in folder */
    ...
    $.get("core/veeam.php", {"action" : "getonedriveitems", "folderid" : folderid, "rid" : rid, "userid" : userid, "offset" : offset, "type" : "folders"}).done(function(data) {
        responsefolders = JSON.parse(data);
    });

    $.get("core/veeam.php", {"action" : "getonedriveitems", "folderid" : folderid, "rid" : rid, "userid" : userid, "offset" : offset, "type" : "documents"}).done(function(data) {
        responsedocuments = JSON.parse(data);
    });
